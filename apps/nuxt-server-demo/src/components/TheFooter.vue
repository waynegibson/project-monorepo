    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
        ...
        <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
          ...
          <div class="mt-4 sm:mt-0 sm:ml-4 sm:flex-shrink-0">
            <button type="submit" class="flex w-full items-center justify-center rounded-md bg-indigo-500 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
              Subscribe
            </button>
          </div>
        </form>
      ...
      <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
          &copy; 2023 Demo Company, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
